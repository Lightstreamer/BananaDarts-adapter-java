...
public class Constants {
    ...
    //Real-world 
    //Dartboard diameter 18 inches    ---> 45.72 cm  --> 200 --> this is the base conversion thus to convert cm to our unit do -> 200/45.72 * val -> 4.37445319335 * val
    ...
    //Dart length (can't find info, but it seems a little longer than the triple-score circle that's 94) --> 96
  ...
  //why didn't we use only positive positions?
    ...
    public static final double ARM_REACH = MAX_SIZE_Z - cmToUnit(32);
    ...
    private static final double ACCELERATION_UNIT_MS_SQUARE = cmToUnit(MOON_GRAVITY/10000); //(9.81/1000000)*100 cm/ms^2;
    public static final double HALF_ACCELERATION = ACCELERATION_UNIT_MS_SQUARE/2;

    public static final double BOARD_THICKNESS = 10;
